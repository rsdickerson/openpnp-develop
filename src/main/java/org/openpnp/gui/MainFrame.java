...
public class MainFrame extends JFrame {
	...
	public MainFrame(Configuration configuration) {
		...
		setBounds(prefs.getInt(PREF_WINDOW_X, PREF_WINDOW_X_DEF), prefs.getInt(PREF_WINDOW_Y, PREF_WINDOW_Y_DEF),
		...
		try {
			...
			MessageBoxes.errorBox(this, "Configuration Load Error",
					"There was a problem loading the configuration. The reason was:<br/><br/>" + e.getMessage()
							+ "<br/><br/>"
	...
	public void splitWindows() {
		if (prefs.getBoolean(PREF_WINDOW_STYLE_MULTIPLE, PREF_WINDOW_STYLE_MULTIPLE_DEF)) {
			...
			// relocated panels 'panelCameraAndInstructions' &
	...
	public void showInstructions(String title, String instructions, boolean showCancelButton, boolean showProceedButton,
			String proceedButtonText, ActionListener cancelActionListener, ActionListener proceedActionListener) {
	...
	private Action checkForUpdatesAction = new AbstractAction("Check For Updates...") {
		...
		public void actionPerformed(ActionEvent arg0) {
			try {
				...
				Method launchApplication = applicationLauncher.getMethod("launchApplication", String.class,
	...
	private Action quickStartLinkAction = new AbstractAction("Quick Start") {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			try {
				...
				MessageBoxes.errorBox(MainFrame.this, "Unable to launch default browser.",
						"Unable to launch default browser. Please visit " + uri);
			}
		}
	};
