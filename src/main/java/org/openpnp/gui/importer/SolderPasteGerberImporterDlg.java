...
class SolderPasteGerberImporterDlg extends JDialog {
	...
	private class SwingAction_2 extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			SolderPasteGerberImporterDlg.this.solderPasteGerberImporter.bottomFile = new File(
					textFieldBottomFile.getText());
			...
			try {
				if (SolderPasteGerberImporterDlg.this.solderPasteGerberImporter.topFile.exists()) {
					List<BoardPad> topPads = new Rs274xParser()
							.parseSolderPastePads(SolderPasteGerberImporterDlg.this.solderPasteGerberImporter.topFile);
