...
public class EagleMountsmdUlpImporter implements BoardImporter {
	...
	public static List<Placement> parseFile(File file, Side side, boolean createMissingParts) throws Exception {
		...
		while ((line = reader.readLine()) != null) {
			...
			placement.setLocation(new Location(LengthUnit.Millimeters, Double.parseDouble(fields[1]),
					Double.parseDouble(fields[2]), 0, Double.parseDouble(fields[3])));
