...
public class JBindings {
	public static <SS, SV, TS, TV> WrappedBinding<SS, SV, TS, TV> bind(SS source, String sourcePropertyName, TS target,
	...
	public static <SS, SV, TS, TV> WrappedBinding<SS, SV, TS, TV> bind(SS source, String sourcePropertyName, TS target,
		...
		return new WrappedBinding<>(source, sourcePropertyName, target, targetPropertyName, converter,
				(BindingListener[]) null);
	}

	public static <SS, SV, TS, TV> WrappedBinding<SS, SV, TS, TV> bind(SS source, String sourcePropertyName, TS target,
			String targetPropertyName, Converter<SV, TV> converter, BindingListener... listeners) {
		return new WrappedBinding<>(source, sourcePropertyName, target, targetPropertyName, converter, listeners);
	}

	public static <SS, SV, TS, TV> WrappedBinding<SS, SV, TS, TV> bind(SS source, String sourcePropertyName, TS target,
			String targetPropertyName, BindingListener... listeners) {
		return new WrappedBinding<>(source, sourcePropertyName, target, targetPropertyName, null, listeners);
	}
	...
	public static class WrappedBinding<SS, SV, TS, TV> {
		...
		public WrappedBinding(SS source, String sourcePropertyName, TS target, String targetPropertyName,
			...
			wrappedBinding = Bindings.createAutoBinding(UpdateStrategy.READ_WRITE, wrapper, wrapperProperty, target,
					targetProperty);
			if (converter != null) {
			...
			wrappedBinding.bind();
			AutoBinding<SS, SV, Wrapper<SV>, SV> binding = Bindings.createAutoBinding(UpdateStrategy.READ, source,
					sourceProperty, wrapper, wrapperProperty);
			binding.bind();
		}
