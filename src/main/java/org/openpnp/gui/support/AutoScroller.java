...
/**
 * The AutoScroller will attempt to keep the viewport positioned based on the
...
public class AutoScroller implements AdjustmentListener {
	...
	private void checkScrollBar(AdjustmentEvent e) {
		...
		/*
		 * Reset the "value" so we can reposition the viewport and distinguish
		 * between a user scroll and a program scroll.
		 */
		if (adjustScrollBar) {
