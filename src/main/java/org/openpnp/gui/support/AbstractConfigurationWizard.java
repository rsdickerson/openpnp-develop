...
public abstract class AbstractConfigurationWizard extends JPanel implements Wizard {
	...
	public WrappedBinding addWrappedBinding(Object source, String sourceProperty, Object target, String targetProperty,
			Converter converter) {
		return addWrappedBinding(JBindings.bind(source, sourceProperty, target, targetProperty, converter));
	}

	public WrappedBinding addWrappedBinding(Object source, String sourceProperty, Object target,
			String targetProperty) {
		return addWrappedBinding(JBindings.bind(source, sourceProperty, target, targetProperty));
	}

	public AutoBinding bind(UpdateStrategy updateStrategy, Object source, String sourceProperty, Object target,
			String targetProperty) {
		return BeanUtils.bind(updateStrategy, source, sourceProperty, target, targetProperty);
	}

	public AutoBinding bind(UpdateStrategy updateStrategy, Object source, String sourceProperty, Object target,
			String targetProperty, Converter converter) {
