...
public class DlgAutoPanelize extends JDialog {
	...
	public DlgAutoPanelize(Frame parent, JobPanel jobPanel) {
		...
		textFieldboardXSpacing.setText(String.format("%.3f", jobPanel.getJob().getPanels().get(0).getXGap()
		...
		textFieldboardYSpacing.setText(String.format("%.3f", jobPanel.getJob().getPanels().get(0).getYGap()
				.convertToUnits(Configuration.get().getSystemUnits()).getValue()));
		...
		textFieldboardPanelFid1X
				.setText(String.format("%.3f", fid0Loc.convertToUnits(Configuration.get().getSystemUnits()).getX()));
		...
		textFieldboardPanelFid1Y
				.setText(String.format("%.3f", fid0Loc.convertToUnits(Configuration.get().getSystemUnits()).getY()));
		...
		textFieldboardPanelFid2X
				.setText(String.format("%.3f", fid1Loc.convertToUnits(Configuration.get().getSystemUnits()).getX()));
		...
		textFieldboardPanelFid2Y
				.setText(String.format("%.3f", fid1Loc.convertToUnits(Configuration.get().getSystemUnits()).getY()));
