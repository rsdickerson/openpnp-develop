...
public class MultisortTableHeaderCellRenderer extends DefaultTableHeaderCellRenderer {
	...
	/**
	 * Constructs a <code>MultisortTableHeaderCellRenderer</code> with the
	 * specified alpha. A lower value represents greater contrast between icons,
	 * while a higher value can make more sort icons visible.
	 * 
	 * @param alpha
	 ...
	 * opaque, and the opacity is reduced by a factor of <code>alpha</code> for
	 * each subsequent sort index.
	 *
	 * @param table
