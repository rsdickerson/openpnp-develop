...
public class PlacementsTableModel extends AbstractTableModel {
	...
	private String[] columnNames = new String[] { "Id", "Part", "Side", "X", "Y", "Rot.", "Type", "Status",
			"Check Fids" };

	private Class[] columnTypes = new Class[] { PartCellValue.class, Part.class, Side.class, LengthCellValue.class,
			LengthCellValue.class, RotationCellValue.class, Type.class, Status.class, Boolean.class, Boolean.class };
