...
public class VisionUtils {
	 ...
	 * centered over the pixel coordinates.
	 * 
	 ...
	 * offsets will be +, -.
	 * 
	 * Calling camera.getLocation().add(getPixelCenterOffsets(...) will give you
	 * the location of x, y with respect to the center of the camera.
	 * 
	 * @param camera
	 * @param x
	 * @param y
	...
	/**
	 * Using the given camera, try to find a QR code and return it's text. This
	 * is just a wrapper for the generic scanBarcode(Camera) function. This one
	 * was added before the other and I don't want to remove it in case people
	 * are using it, but it does the same thing.
	 * 
	 * @param camera
	 * @return
	 */
	...
	/**
	 * Using the given camera, try to find any supported barcode and return it's
	 * text.
	 * 
	 * @param camera
	 * @return
