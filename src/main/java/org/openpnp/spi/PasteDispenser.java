...
public interface PasteDispenser extends HeadMountable, WizardConfigurable, PropertySheetHolder {
	/**
	 ...
	 * startLocation. If both locations are null the dispenser will dispense at
