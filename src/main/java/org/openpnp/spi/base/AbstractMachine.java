...
public abstract class AbstractMachine extends AbstractModelObject implements Machine {
	 ...
	 * History:
	 * 
	 * Note: Can't actually use the @Version annotation because of a bug in
	 * SimpleXML. See http://sourceforge.net/p/simple/mailman/message/27887562/
	 * 
	 * 1.0: Initial revision. 1.1: Added jobProcessors Map and deprecated
	 * JobProcesor and JobPlanner.
	 */
