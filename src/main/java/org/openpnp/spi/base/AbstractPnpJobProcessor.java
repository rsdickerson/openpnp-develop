...
public abstract class AbstractPnpJobProcessor extends AbstractJobProcessor implements PnpJobProcessor {
	...
	/**
	 * Discard the Part, if any, on the given Nozzle. the Nozzle is returned to
	 * Safe Z at the end of the operation.
	 * 
	 * @param nozzle
	 * @throws Exception
	 */
	 ...
	 * @return
	 * @throws Exception
	 *             If no compatible NozzleTip can be found.
	 */
	 ...
	 * @return
	 * @throws Exception
	 *             If no Feeder is found that is both enabled and is serving the
	 *             Part.
	 */
