...
public abstract class AbstractJobProcessor implements JobProcessor {
	...
	public enum State {
		STOPPED, RUNNING, ERROR, FINISHED
	}
	...
	/**
	 * Call the Retryable's action method until it either does not throw an
	 * Exception or it is called maxTries number of times. If the method throws
	 * an Exception each time then this method will throw the final Exception.
	 * 
	 * @param maxTries
	 * @param r
	 * @throws Exception
