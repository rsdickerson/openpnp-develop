...
public class OpenCvCamera extends ReferenceCamera implements Runnable {
	...
	private void initCamera() {
		...
		try {
			 ...
			 * https://github.com/openpnp/openpnp/issues/395 some cameras may
			 * only handle resolution changes before opening while others handle
			 * it after so we do both to try to cover both cases.
			 */
			if (preferredWidth != 0) {
	...
	public enum OpenCvCaptureProperty {
		CAP_PROP_POS_MSEC(0), // !< Current position of the video file in
								// milliseconds.
		CAP_PROP_POS_FRAMES(1), // !< 0-based index of the frame to be
								// decoded/captured next.
		CAP_PROP_POS_AVI_RATIO(2), // !< Relative position of the video file:
									// 0=start of the film,
									// 1=end of the film.
		CAP_PROP_FRAME_WIDTH(3), // !< Width of the frames in the video stream.
		CAP_PROP_FRAME_HEIGHT(4), // !< Height of the frames in the video
									// stream.
		CAP_PROP_FPS(5), // !< Frame rate.
		CAP_PROP_FOURCC(6), // !< 4-character code of codec. see
							// VideoWriter::fourcc .
		CAP_PROP_FRAME_COUNT(7), // !< Number of frames in the video file.
		CAP_PROP_FORMAT(8), // !< Format of the %Mat objects returned by
							// VideoCapture::retrieve().
		CAP_PROP_MODE(9), // !< Backend-specific value indicating the current
							// capture mode.
		CAP_PROP_BRIGHTNESS(10), // !< Brightness of the image (only for
									// cameras).
		CAP_PROP_CONTRAST(11), // !< Contrast of the image (only for cameras).
		CAP_PROP_SATURATION(12), // !< Saturation of the image (only for
									// cameras).
		...
		CAP_PROP_RECTIFICATION(18), // !< Rectification flag for stereo cameras
									// (note: only
									// supported by DC1394 v 2.x backend
									// currently).
		CAP_PROP_MONOCHROME(19), CAP_PROP_SHARPNESS(20), CAP_PROP_AUTO_EXPOSURE(21), // !<
																						...
																						// this
																						// feature.
		CAP_PROP_GAMMA(22), CAP_PROP_TEMPERATURE(23), CAP_PROP_TRIGGER(24), CAP_PROP_TRIGGER_DELAY(
				25), CAP_PROP_WHITE_BALANCE_RED_V(26), CAP_PROP_ZOOM(27), CAP_PROP_FOCUS(28), CAP_PROP_GUID(
						29), CAP_PROP_ISO_SPEED(30), CAP_PROP_BACKLIGHT(32), CAP_PROP_PAN(
								33), CAP_PROP_TILT(34), CAP_PROP_ROLL(35), CAP_PROP_IRIS(36), CAP_PROP_SETTINGS(37), // !
																														// Pop
																														// up
																														// video/camera
																														// filter
