...
public class OpenCvCameraConfigurationWizard extends ReferenceCameraConfigurationWizard {
	...
	public OpenCvCameraConfigurationWizard(OpenCvCamera camera) {
		...
		panel = new JPanel();
		panel.setBorder(new TitledBorder(null, "Properties (Experimental)", TitledBorder.LEADING, TitledBorder.TOP,
				null, null));
	...
	public Action readPropertyValueAction = new AbstractAction() {
		...
		public void actionPerformed(ActionEvent arg0) {
			propertyValueTf.setText(
					"" + camera.getOpenCvCapturePropertyValue((OpenCvCaptureProperty) propertyCb.getSelectedItem()));
		}
	};
