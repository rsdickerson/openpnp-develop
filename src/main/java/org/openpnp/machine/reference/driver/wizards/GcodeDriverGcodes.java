...
public class GcodeDriverGcodes extends AbstractConfigurationWizard {
	...
	public GcodeDriverGcodes(GcodeDriver driver) {
		...
		gcodePanel.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null), "Gcode",
		...
		importExportPanel.setBorder(
				new TitledBorder(null, "Import / Export", TitledBorder.LEADING, TitledBorder.TOP, null, null));
