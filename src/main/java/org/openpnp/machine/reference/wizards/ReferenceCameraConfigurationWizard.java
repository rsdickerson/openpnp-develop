...
public class ReferenceCameraConfigurationWizard extends AbstractConfigurationWizard {
	...
	public ReferenceCameraConfigurationWizard(ReferenceCamera referenceCamera) {
		...
		panelOffsets.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null), "Offsets",
		...
		panelGeneral.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null), "Transformation",
				TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		panelLensCalibration.setBorder(
				new TitledBorder(null, "Lens Calibration", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		try {
			...
			if (referenceCamera.getHead() == null) {
				// Fixed camera, add the location fields and buttons and turn
				// off offsets.
				locationButtonsPanel = new LocationButtonsPanel(textFieldLocationX, textFieldLocationY,
						textFieldLocationZ, textFieldLocationRotation);
