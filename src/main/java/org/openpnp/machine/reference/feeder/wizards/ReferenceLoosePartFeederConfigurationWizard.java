...
public class ReferenceLoosePartFeederConfigurationWizard extends AbstractReferenceFeederConfigurationWizard {
	...
	public ReferenceLoosePartFeederConfigurationWizard(ReferenceLoosePartFeeder feeder) {
		...
		panel.setBorder(new TitledBorder(null, "Vision", TitledBorder.LEADING, TitledBorder.TOP, null, null));
