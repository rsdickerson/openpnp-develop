...
public class ReferenceStripFeeder extends ReferenceFeeder {
	...
	private Location findClosestHole(Camera camera) {
		...
		BufferedImage image = new FluentCv().setCamera(camera).settleAndCapture("original")
				.saveDebugImage(ReferenceStripFeeder.class, "findClosestHole", "original").toGray()
				...
				.saveDebugImage(ReferenceStripFeeder.class, "findClosestHole", "debug").toBufferedImage();
