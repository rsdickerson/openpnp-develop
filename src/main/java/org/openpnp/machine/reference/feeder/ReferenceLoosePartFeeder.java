...
public class ReferenceLoosePartFeeder extends ReferenceFeeder {
	...
	private Location getPickLocation(Camera camera) throws Exception {
		...
		// Update the location with the correct Z, which is the configured
		// Location's Z
		// plus the part height.
		location = location.derive(null, null, this.location.convertToUnits(location.getUnits()).getZ()
	...
	public static CvPipeline createDefaultPipeline() {
		try {
			String xml = IOUtils.toString(
					ReferenceLoosePartFeeder.class.getResource("ReferenceLoosePartFeeder-DefaultPipeline.xml"));
