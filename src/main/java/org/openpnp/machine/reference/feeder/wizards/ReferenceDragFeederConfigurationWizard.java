...
public class ReferenceDragFeederConfigurationWizard extends AbstractReferenceFeederConfigurationWizard {
	...
	public ReferenceDragFeederConfigurationWizard(ReferenceDragFeeder feeder) {
		...
		panelTemplate.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null), "Template Image",
		...
		panelAoE = new JPanel();
		panelAoE.setBorder(
				new TitledBorder(null, "Area of Interest", TitledBorder.LEADING, TitledBorder.TOP, null, null));
