...
public class ReferenceMachine extends AbstractMachine {
	...
	public PropertySheetHolder[] getChildPropertySheetHolders() {
		...
		children.add(new SimplePropertySheetHolder("Job Processors", Arrays.asList(
				getPnpJobProcessor()/* , getPasteDispenseJobProcessor() */)));
	...
	public List<Class<? extends Feeder>> getCompatibleFeederClasses() {
		...
		l.add(ReferenceSternStripFeeder.class);
