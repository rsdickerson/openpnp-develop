...
public class Package {
	...
	@XmlElements({ @XmlElement(name = "polygon", type = Polygon.class), @XmlElement(name = "wire", type = Wire.class),
			...
			@XmlElement(name = "circle", type = Circle.class), @XmlElement(name = "rectangle", type = Rectangle.class),
			@XmlElement(name = "frame", type = Frame.class), @XmlElement(name = "hole", type = Hole.class),
			@XmlElement(name = "pad", type = Pad.class), @XmlElement(name = "smd", type = Smd.class) })
