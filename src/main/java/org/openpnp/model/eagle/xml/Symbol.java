...
@XmlType(name = "", propOrder = { "description", "polygonOrWireOrTextOrDimensionOrPinOrCircleOrRectangleOrFrame" })
...
public class Symbol {
	...
	@XmlElements({ @XmlElement(name = "polygon", type = Polygon.class), @XmlElement(name = "wire", type = Wire.class),
			@XmlElement(name = "text", type = Text.class), @XmlElement(name = "dimension", type = Dimension.class),
			@XmlElement(name = "pin", type = Pin.class), @XmlElement(name = "circle", type = Circle.class),
