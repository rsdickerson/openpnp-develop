...
public class Length {
	...
	public Length convertToUnits(LengthUnit units) {
		...
		// First convert the current value to millimeters, which we use as a
		// base unit.
		double mm = 0;
	 ...
	 * @return
	 */
	public static Location setLocationField(Configuration configuration, Location location, Length length,
			Field field) {
