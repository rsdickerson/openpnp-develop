...
public class LensCalibration {
	...
	public LensCalibration(LensModel lensModel, Pattern pattern, int patternWidth, int patternHeight, double objectSize,
			long applyDelayMs) {
	...
	public boolean calibrate() {
		...
		if (lensModel == LensModel.Fisheye) {
			...
			rms = Calib3d.calibrateCamera(objectPointsList, imagePointsList, imageSize, cameraMatrix,
