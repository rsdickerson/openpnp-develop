...
public class FindContours extends CvStage {
	public enum RetrievalMode {
		ConnectedComponent(Imgproc.RETR_CCOMP), External(Imgproc.RETR_EXTERNAL), FloodFill(
				Imgproc.RETR_FLOODFILL), List(Imgproc.RETR_LIST), Tree(Imgproc.RETR_TREE);
	...
	public enum ApproximationMethod {
		None(Imgproc.CHAIN_APPROX_NONE), Simple(Imgproc.CHAIN_APPROX_SIMPLE), Tc89Kcos(
				Imgproc.CHAIN_APPROX_TC89_KCOS), Tc89L1(Imgproc.CHAIN_APPROX_TC89_L1);
