...
/**
 * GrabCut algorithm was designed by Carsten Rother, Vladimir Kolmogorov &
 * Andrew Blake from Microsoft Research Cambridge, UK. in their paper,
 * "GrabCut": interactive foreground extraction using iterated graph cuts . An
 * algorithm was needed for foreground extraction with minimal user interaction,
