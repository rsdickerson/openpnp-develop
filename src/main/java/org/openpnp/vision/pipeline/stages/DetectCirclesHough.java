...
/**
 * Finds circles in the working image and stores the results as a List<Circle>
 * on the model.
 */
public class DetectCirclesHough extends CvStage {
	...
	/**
	 * Second method-specific parameter. In case of CV_HOUGH_GRADIENT , it is
	...
	public Result process(CvPipeline pipeline) throws Exception {
		...
		Mat output = new Mat();
		Imgproc.HoughCircles(mat, output, Imgproc.CV_HOUGH_GRADIENT, dp, minDistance, param1, param2, minDiameter / 2,
				maxDiameter / 2);
