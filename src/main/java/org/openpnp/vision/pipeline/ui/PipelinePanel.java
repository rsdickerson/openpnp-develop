...
public class PipelinePanel extends JPanel {
	...
	public PipelinePanel(CvPipelineEditor editor) {
		...
		// Listen for changes to the selection of the table and update the
		// properties for the
		// selected stage.
		...
		// Listen for changes to the structure of the table (adding or removing
		// rows) and process
		...
		// Listen for editing events in the stages table and process the
		// pipeline to update the
		// results.
		...
		// Listen for editing events in the properties and process the pipeline
		// to update the
		// results.
