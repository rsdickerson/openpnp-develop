...
/**
 * A JPanel based component for editing a CvPipeline. Allows the user to add and
 * remove stages, modify properties of each stage, see the image and model
 * results from each stage and export and import the pipeline from the
 * clipboard.
 * 
 * The static method #registerStageClass can be used to register a CvStage
 * implementation with this component, allowing the user to select the
 * implementation from the list when creating a new stage.
 * 
