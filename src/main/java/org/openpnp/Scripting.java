...
public class Scripting {
	...
	public Scripting() {
		// Collect all the script filename extensions we know how to handle from
		// the list of
		...
		this.scriptsDirectory = new File(Configuration.get().getConfigurationDirectory(), "scripts");

		// Create the scripts directory if it doesn't exist and copy the example
		// scripts
		// over.
		...
		// TODO: It would be better if we just copied all the files from the
		// Examples
		...
		examplesDir.mkdirs();
		String[] exampleScripts = new String[] { "JavaScript/Call_Java.js", "JavaScript/Hello_World.js",
				"JavaScript/Print_Scripting_Info.js", "JavaScript/Reset_Strip_Feeders.js", "JavaScript/Move_Machine.js",
				"JavaScript/Utility.js", "JavaScript/QrCodeXout.js", "Python/Print_Hallo_OpenPnP.py",
				"Python/Print_Methods_Vars.py", "Python/Print_Nozzle_Info.py" };
	...
	public void setMenu(JMenu menu) {
		this.menu = menu;
		// Add a separator and the Refresh Scripts and Open Scripts Directory
		// items
		menu.addSeparator();
	...
	private synchronized void synchronizeMenu(JMenu menu, File directory) {
		...
		// Remove any menu items that don't have a matching entry in the
		// directory
	...
	private void addSorted(JMenu menu, JMenuItem item) {
		...
		for (int i = 0; i < menu.getItemCount(); i++) {
			...
			if (existingItem == null
					|| item.getText().toLowerCase().compareTo(existingItem.getText().toLowerCase()) <= 0) {
				menu.insert(item, i);
				return;
			}
		}
