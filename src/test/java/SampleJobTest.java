...
public class SampleJobTest {
	...
	/**
	 * Loads the pnp-test job that is included in the samples and attempts to
	 * run it within a test harness. The job is expected to complete
	...
	public void testSampleJob() throws Exception {
		...
		// MpegEncodingCameraListener encoder = new
		// MpegEncodingCameraListener(videoFile);
