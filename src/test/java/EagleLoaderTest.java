...
public class EagleLoaderTest {
	...
	public void testLoadBoard() throws Exception {
		EagleLoader loader = new EagleLoader(ClassLoader.getSystemResourceAsStream("samples/eagle/eagle.brd"));
	...
	public void testLoadSchematic() throws Exception {
		EagleLoader loader = new EagleLoader(ClassLoader.getSystemResourceAsStream("samples/eagle/eagle.sch"));
