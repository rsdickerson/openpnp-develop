...
public class BasicJobTest {
	...
	public static Placement createPlacement(String id, String partId, double x, double y, double z, double rotation,
			Side side) {
	...
	public static class BasicJobTestDriverDelegate extends TestDriverDelegate {
		...
		class ExpectedMove extends ExpectedOp {
			...
			public ExpectedMove(String description, HeadMountable headMountable, Location location, double speed) {
